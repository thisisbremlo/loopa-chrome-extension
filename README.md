...
Loopa Extension is the source-available Chrome extension add-on for [loopa.framer.site](https://loopa.framer.site). It brings Loopa search, browsing, opening, and saving into the browser toolbar, without requiring the website to be opened first.
